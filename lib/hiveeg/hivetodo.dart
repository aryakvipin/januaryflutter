...
class _MyTODoState extends State<MyTODo> {
  ...
  /// updating hive data
Future<void> udpdatetask(int key,Map<String,dynamic> uptask)async {
  ...
  Map<String,dynamic>readata(int key){
    final data =tbox.getAt(key);
    return data;
  }
              ...
              children: [
                ...
                ElevatedButton(
                    onPressed: () async {
                      if (id == null) {
                        createTask(
                            {'name': name_controller.text, 'details': details_controller.text
                            }
                            );
                      }
                      if(id !=null){
                        udpdatetask(id, {'name': name_controller.text,
